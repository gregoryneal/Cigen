...
// destroyed by the developer of the anisotropic least cost path finder
// in the first quarter of 2025 in pursuit of an even basicer FPCC.
// ------------------------------------------ 
...
public class BasicFPCC : MonoBehaviour
{
    ...
    void Initialize()
    {
        ...
        if (cameraTx != null) cameraStartY = cameraTx.localPosition.y;
    ...
    void ProcessLook()
    {
        ...
        if (cameraTx != null) cameraTx.localRotation = Quaternion.Euler( xRotation, 0f, 0f );
